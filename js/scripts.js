...
//--------------Creating an element for the type------------------------------
        let typesElement = '<p><strong>Types: </strong></p>'
        poke_mon.types.forEach(function (el) {
        typesElement = typesElement + '<p>' + el.type.name+ '</p>'
       })

//--------------Creating an element for abilites------------------------------
       let abilitiesElement = '<p><strong>Abilities: </strong></p>'
       poke_mon.abilities.forEach(function (el) {
       abilitiesElement = abilitiesElement + '<p>' + el.ability.name+ '</p>'
      })
